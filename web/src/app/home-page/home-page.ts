...
import levenshtein from 'fast-levenshtein'; // a hibapontos keresést egyszerűsití meg
import { BehaviorSubject, combineLatest, debounceTime, map, Observable, of, startWith, take } from 'rxjs';
...
export class HomePage {
  ...
  filteredJobs$: Observable<JobViewDto[]> = of([]);
